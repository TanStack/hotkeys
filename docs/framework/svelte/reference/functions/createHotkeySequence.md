...
Defined in: [packages/svelte-hotkeys/src/createHotkeySequence.svelte.ts:69](https://github.com/TanStack/hotkeys/blob/main/packages/svelte-hotkeys/src/createHotkeySequence.svelte.ts#L69)
