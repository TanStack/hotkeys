...
Defined in: [packages/svelte-hotkeys/src/createHotkeySequences.svelte.ts:59](https://github.com/TanStack/hotkeys/blob/main/packages/svelte-hotkeys/src/createHotkeySequences.svelte.ts#L59)
