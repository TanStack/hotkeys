...
Defined in: [key-state-tracker.ts:16](https://github.com/TanStack/hotkeys/blob/main/packages/hotkeys/src/key-state-tracker.ts#L16)
...
Defined in: [key-state-tracker.ts:11](https://github.com/TanStack/hotkeys/blob/main/packages/hotkeys/src/key-state-tracker.ts#L11)
