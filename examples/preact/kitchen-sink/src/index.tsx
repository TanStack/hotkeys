...
function Layout() {
  ...
  const Page = routeComponents[path] ?? Tickets
    ...
    <section>
      ...
      <label>
        ...
        <select
          value={platform}
          onChange={(e) =>
            setPlatform(e.currentTarget.value as typeof platform)
          }
        >
...
import.meta.hot?.dispose(() => render(null, document.getElementById('root')!))
