...
- feat: add `createHotkeys` primitive for registering multiple hotkeys in one call ([#75](https://github.com/TanStack/hotkeys/pull/75))
...
- Initial release of SolidJS adapter for TanStack Hotkeys
